...
This Bachelor's Thesis shall test VPP torwards IPv4 versus IPv6, packet sizes,
cpu scaling (optionally multi socket NUMA architectures) and routing table sizes
(BGP table size \textgreater 600.000 entries in 2017 \cite{bgphelp:1}).
Optionally one specific VPP feature can be analyzed, too, like tunneling,
firewall or NAT.

Measurement results shall contain package count (per time), latency, package
loss and whitebox testing results: Cpu load and cache misses.
