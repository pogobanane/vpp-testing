...
tester to generate loads.

VPP shall be tested torwards IPv4 versus IPv6, packet sizes, cpu scaling
(optionally multi socket NUMA architectures) and routing table sizes (BGP table
size \textgreater 600.000 entries in 2017 \cite{bgphelp:1}). Optionally one
specific VPP feature can be analyzed, too, like tunneling, firewall or NAT.
