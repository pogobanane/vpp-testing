...
\doubletextbox{39ex}{Testing Methodology}{
	...
	\footnotesize
	For tests to return meaningful latency results, the optimum of throughput to latency is beeing found by a script. This packet rate is then used for further tests. Otherwise the results are inaccurate, because of utilization of the packet buffer. 
