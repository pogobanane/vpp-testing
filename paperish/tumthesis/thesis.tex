...
\supervisor{\NEThead}
\advisor{}
\assistants{Paul Emmerich, Leonardo Linguaglossa, Dominik Scholz}
...
\input{include/2.1-2-background-related_work}
\input{include/2.3-analysis}
\input{include/2.4-methodology}
\input{include/2.5-model}

\input{include/3-conclusion}
