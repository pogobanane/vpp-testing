...
This means for layer 2 configurations the packet throughput $p$ can be
...
that the latency is around $\SC{5}{\mu s}$ for low line rates and
slowly increases torwards reaching the maximum throughput. When this
