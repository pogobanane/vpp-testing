...
... its vectorized processing of packets in badges as the name
indicates. This allows for better optimization.

... its support for \Ac{dpdk} with its fast, user-space NIC drivers.
With it come also virtual packet interfaces for fast links to local
virtualized systems.

... its modular packet processing graph. Specific features are
