...
\DeclareAcronym{vpe}{
	short				= {\sc{vPE}},
	long				= {Virtual Provider Edge},
	list				= {\Acl{vpe}.},
	extra				= {%
		A Cisco \Ac{sdn} product group.
	}
}
\DeclareAcronym{vmdc}{
	short				= {\sc{VMDC}},
...
\DeclareAcronym{config}{
	...
	list				= {\Acl{config}.},
	extra				= {%
		Refers to \Ac{vpp}'s startup configuration file.  
	}
}
...
\DeclareAcronym{exec}{
	...
	list				= {\Acl{exec}.},
	extra				= {%
		Refers to \Ac{vpp}'s on startup executed file.  
	}
}
...
\DeclareAcronym{hqos}{
	short				= {\sc{HQoS}},
	long				= {Hierarchical Quality of Service},
	list				= {\Acl{hqos}.},
	extra				= {%
		A hierarchical type of scheduling of packet sending.  
	}
}

\DeclareAcronym{rss}{
	short				= {\sc{RSS}},
	long				= {Receive Side Scaling},
	list				= {\Acl{rss}.},
	extra				= {%
